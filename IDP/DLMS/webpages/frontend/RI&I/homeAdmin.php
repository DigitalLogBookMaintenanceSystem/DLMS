    ...
    <div class="container">
      <nav class="navbar">
        ...
        <div class="navbar__left">
          <a href="homeQm.php">Quarter Master</a>
          <a href="homeLogBook.php">Log Book</a>
          <a class="active_link" href="homeAdmin.php">Admin</a>
        </div>
          ...
          <div class="main__cards">
            <div class="card">
              ...
              <div class="card_inner">
                <p class="text-primary-p">Number of Active Units</p>
            ...
            <div class="card">
              ...
              <div class="card_inner">
                <p class="text-primary-p">Logbook registered</p>
                <!-- number will be counted by the db -->
                <span class="font-bold text-title">???</span>
              </div>
            </div>
            ...
            <div class="card">
              ...
              ></i>
              <div class="card_inner">
                <p class="text-primary-p">Pending Workorders</p>
                <span class="font-bold text-title">???</span>
              </div>
            </div>
            ...
            <div class="card">
              ...
              ></i>
              <div class="card_inner">
                <p class="text-primary-p">Job cards</p>
                <span class="font-bold text-title">???</span>
              </div>
            </div>
          </div>
